...
// in DESIGN.md's Elevation & Depth section).
...
export default function LoginPage() {
  return (
    <div className="relative flex flex-1 items-center justify-center bg-board-ground px-5 py-16">
      <div
        aria-hidden
      ...
      <div className="motion-safe:animate-[login-settle_0.5s_cubic-bezier(0,0.6,0.2,1)_both] relative w-full max-w-[22rem]">
        <div className="mb-10 flex flex-col items-center gap-1 text-center">
          <span className="text-lg font-bold tracking-[0.14em] text-chalk-white uppercase">
            CPAM Conecta
          </span>
          <span className="text-xs tracking-[0.1em] text-chalk-subtitle uppercase">
